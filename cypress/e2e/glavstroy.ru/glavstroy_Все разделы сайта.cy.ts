describe("Проверка отображения и функциональности элементов всех разделов/подразделов сайта glavstroy.ru: кнопок/иконок/ссылок, форм подписки и поиска по сайту", () => {
